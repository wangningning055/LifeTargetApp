<template>
  <view class="empty">
    ...
    <view class="cta" @tap="$emit('create')">{{ buttonText }}</view>
  </view>
</template>
...
.empty {
  ...
  box-shadow: 0 16rpx 44rpx rgba(44, 35, 20, 0.08);
}
...
.orb-a {
  ...
  left: -30rpx;
  top: -20rpx;
  background: radial-gradient(circle, rgba(37, 99, 235, 0.45), rgba(37, 99, 235, 0));
}
